...
path <- '~/GitHub/NERRS_NERRA_2019_R_Training/data'
qaFlags <- c('0', '3', '5')
...
raw_boxplot(df, param = 'atemp', target_yr = '2017')
raw_boxplot(df, param = 'atemp', target_yr = '2017', free_y = TRUE)
#raw_boxplot(df, param = 'bp')
#raw_boxplot(df, param = 'bp', free_y = TRUE)
```
...
```
Note: You specify the full path after the github.com part of the package URL:
